...
def ebgpv4_route_install_config(api, tc):
    ...
    lag2.protocol.lacp.actor_system_id = "01:01:01:01:01:01"
    lag2.protocol.lacp.actor_system_priority = 1
    lag2.protocol.lacp.actor_key = 1

    lp1 = lag1.ports.port(port_name=ptx.name)[0]
    lp2 = lag2.ports.port(port_name=prx.name)[0]

    lp1.ethernet.name = "p1_lag_eth"
    lp1.ethernet.mac = "00:00:00:00:00:16"
    lp1.lacp.actor_port_number = 1
    lp1.lacp.actor_port_priority = 1
    lp1.lacp.actor_activity = "active"

    lp2.ethernet.name = "p2_lag_eth"
    lp2.ethernet.mac = "00:00:00:00:00:17"
    lp2.lacp.actor_port_number = 1
    lp2.lacp.actor_port_priority = 1
    lp2.lacp.actor_activity = "active"
